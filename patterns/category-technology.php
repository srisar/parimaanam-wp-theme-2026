...
<!-- wp:group {"align":"full","backgroundColor":"paper","className":"home-category-showcase","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","right":"var:preset|spacing|40","bottom":"var:preset|spacing|70","left":"var:preset|spacing|40"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull home-category-showcase has-paper-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--40)"><!-- wp:heading {"align":"wide","className":"home-category-showcase__heading","fontSize":"x-large"} -->
	...
	<div class="wp-block-query alignwide home-category-showcase__features"><!-- wp:post-template {"align":"wide","layout":{"type":"grid","columnCount":null,"minimumColumnWidth":"16rem"}} -->
		<!-- wp:group {"tagName":"article","backgroundColor":"surface","className":"home-category-showcase__feature-card","layout":{"type":"constrained"}} -->
