...
<!-- wp:group {"align":"wide","className":"home-category-section","style":{"spacing":{"margin":{"top":"var:preset|spacing|80"},"padding":{"top":"var:preset|spacing|60"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide home-category-section" style="margin-top:var(--wp--preset--spacing--80);padding-top:var(--wp--preset--spacing--60)"><!-- wp:heading {"align":"wide","className":"home-category-section__heading","fontSize":"x-large"} -->
